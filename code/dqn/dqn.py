...
from environments import SimpleFrameStack, ConstantRewardEnv, RandomObsBinaryRewardEnv, TwoStepDelayedRewardEnv
...
envs = {
        ...
        "MinAtar/Breakout-v0": lambda: gym.make("MinAtar/Breakout-v0"),
}
...
class DQNAgent:
    ...
    def plot_rewards(self, title: str):
    ...
    def plot_moving_average_rewards(self, title: str, window: int = 100):
